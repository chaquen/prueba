...
if ($mysqli->mysqliect_errno) {
  ...
  switch(){
    case "agregar":
     ...
     break;
     case "laccionquequiera":
      hace lo mismo que en la accion agregar  pero con lo que necesita en esta accion recuerde que la accion la enia en la funcion peticion
     break;
     case "laccionquequiera2":
     break;
  }
